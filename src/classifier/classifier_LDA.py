...
def main():
    ...
    with open("classifications/correct_classifications.json") as classifications:
        with open("classifications/classifications_without_commons_LDA_1_all.json") as predictions:
...
def classify_org(category_data):
    ...
    # dumping data
    with open("classifications/classifications_without_commons_LDA_1_all.json", "w") as classifications_json:
